...
!\[SpendHen App Preview](screenshots/app-preview.png)
...
SpendHen is a \*\*personal project\*\* exploring design and implementation in the personal finance space. Instead of forcing users into rigid budgeting systems, it lets them choose their "savings intensity" — from minimal tracking to aggressive goal-setting.



\*\*Why I Built This:\*\*  

I noticed existing finance apps are either too rigid or formulaic. SpendHen adapts to how you \*actually\* want to manage money and keeps you accountable.
...
\- Green "$" indicators on calendar for paydays
...
\*\*Balancing feature richness with UI simplicity requires ruthless prioritization.\*\*



The folder pattern emerged after realizing a flat list of 10+ categories felt overwhelming. The Income/Expenses folder separation came from user feedback wanting clear distinction between "money coming in" and "money going out."



\### What I'd Do Differently

Start with \*\*TypeScript\*\* from day one. As state grew to 40+ variables across 6 pages, type safety would have caught several prop-drilling issues earlier. Also would implement Context API sooner for cross-page state management.
...
\- Challenge myself to build something useful and actionable



\*\*Inspiration:\*\*  

Existing finance apps that either overwhelm with features or oversimplify to the point of being unhelpful. I wanted something in between that \*adapts\* to the user's preference and habits, but demands accountability.
...
\*This is a frontend prototype showcasing UX/UI design, React state management capabilities, and development. Backend integration and data persistence are planned for future development phases.\*
